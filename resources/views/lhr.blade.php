...
<footer style="background: #0a0a0a; border-top: 1px solid rgba(212,181,160,0.1); padding: 100px 0 50px;">
  <div class="cnt">
    <div class="foot-grid">
      ...
      <div class="fc"><h4>Studio</h4><ul><li><a href="/">About Us</a></li><li><a href="/#booking">Book Appointment</a></li><li><a href="https://wa.me/919140971129" target="_blank">WhatsApp</a></li><li><a href="/clinic">Lucknow, U.P.</a></li></ul></div>
    </div>
    <div class="foot-bot">
      <span>&copy; 2025 Skinnovation Aesthetic Studio &middot; Lucknow &middot; All rights reserved.</span>
      <span>Developed by <a href="http://trivoraconsultancy.com/" target="_blank" style="color:#e8c4b4; text-decoration:none; font-weight: 500; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">Trivora Consultancy</a></span>
    </div>
  </div>
</footer>
